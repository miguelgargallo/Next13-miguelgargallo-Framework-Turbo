        ...
        <div className="min-w-screen flex min-h-screen flex-col bg-black">
            ...
            <main>
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="pylarDiv">
                                <motion.img
                                    ...
                                    src="https://raw.githubusercontent.com/superdatas/pylarAI-results/main/121822/1.png"
                ...
                <div className="pylarDiv py-6">
                    ...
                    <motion.img
                        className="pylarDimension"
                        src="https://raw.githubusercontent.com/superdatas/pylarAI-results/main/121822/2.png"
                        alt="Black Hole by Stable Diffusion 2.0 and Pylar Prompt guidelines"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 1.6 }}
                    ...
                    <motion.img
                        className="pylarDimension"
                        src="https://raw.githubusercontent.com/superdatas/pylarAI-results/main/121822/3.png"
                        alt="Black Hole by Stable Diffusion 2.0 and Pylar Prompt guidelines"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 1.8 }}
                    ...
                    <motion.img
                        className="pylarDimension"
                        src="https://raw.githubusercontent.com/superdatas/pylarAI-results/main/121822/4.png"
                        alt="Black Hole by Stable Diffusion 2.0 and Pylar Prompt guidelines"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
